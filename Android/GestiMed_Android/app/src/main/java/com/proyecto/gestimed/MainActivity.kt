 ...
 */
    ...
    private fun addPacientes():ArrayList<Paciente>{
        ...
        pacientes.add(Paciente("Hernandez",listaMedicos,19930620,"Goku2","620220902",listaHabitaciones[0],"1234",listaTratamientos[0],"media"))
        pacientes.add(Paciente("Hernandez",listaMedicos,19930620,"Goku3","620220902",listaHabitaciones[0],"1234",listaTratamientos[0],"baja"))
        return pacientes
    }
    /*
